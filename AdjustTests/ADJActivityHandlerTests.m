...
- (void)testFinishedTracking
{
    ...
    aTest(@"AttributionHandler checkResponse");
    ...
    anTest(@"AttributionHandler checkResponse");
...
- (void) testLaunchSuccessResponseTasks
{
    ...
    eventSuccessResponseData.jsonResponse = @{};

    [activityHandler finishedTracking:eventSuccessResponseData];
    [NSThread sleepForTimeInterval:2.0];

    anTest(@"AttributionHandler checkResponse");
    anDebug(@"Launching failed tracking delegate");
    aDebug(@"Launching success tracking delegate");

    // test success event response data
    eventSuccessResponseData.success = YES;
    eventSuccessResponseData.jsonResponse = nil;
    ...
    anTest(@"AttributionHandler checkResponse");
    anDebug(@"Launching failed tracking delegate");
    anDebug(@"Launching success tracking delegate");
...
- (void) testLaunchFailureResponseTasks
{
    ...
    anTest(@"AttributionHandler checkResponse");
    anDebug(@"Launching success tracking delegate");
    aDebug(@"Launching failed tracking delegate");
...
- (void)testLaunchDeepLink
{
    ...
    [activityHandler launchAttributionTasks:sessionResponseData];
    [NSThread sleepForTimeInterval:2.0];
